 ...
 */
open class DoNothingVisitor : Visitor {
    ...
    override fun visit(parameterDefinition: ParameterDefinition) {}
    override fun visit(procedureDefinition: ProcedureDefinition) {}
    override fun visit(program: Program) {}
    override fun visit(typeDefinition: TypeDefinition) {}
    override fun visit(variableDefinition: VariableDefinition) {}
